...
class TrainLogger(BaseLogger):
    ...
    Attruibutes:
        iter_start_time (time_expand): Records the start time_expand of each iteration
        epoch_start_time (time_expand): Records the start time_expand of each epoch
    ...
    def log_iter(self, loss_dict={}):
        ...
        if self.iter % self.steps_per_print == 0:
            ...
            message = '(epoch: %d, iter: %d, time_expand: %.3f) ' % (
    ...
    def end_epoch(self, metrics=None):
        ...
        """
        self.write('[end of epoch {}/{}, epoch time_expand: {:.2g}]'.format(
