...
class Generator(nn.Module):
    ...
    def __init__(self, input_shape=(128, 128), residual_in_channels=256):
        ...
        self.Cx, self.Tx = input_shape
        self.residual_in_channels=residual_in_channels
        self.flattened_channels = (self.Cx // 4) * residual_in_channels
    ...
    def forward(self, x, mask):
        ...
        reshape1dto2d = reshape1dto2d.view(reshape1dto2d.size(0), self.residual_in_channels, self.Cx//4, -1)
...
if __name__ == '__main__':
    ...
    input = np.random.randn(16, 128, 128)
    ...
    # stat(generator,(16,128,128))
    # stat(discriminator, (16, 128, 128))