...
class MaskCycleGANVCTraining(object):
    ...
    def __init__(self, args):
        ...
        self.dataset_A = self.loadPickleFile(os.path.join(
            args.preprocessed_data_dir, args.boat_A_id, f"{args.boat_A_id}_normalized.pickle"))
        dataset_A_norm_stats = np.load(os.path.join(
            args.preprocessed_data_dir, args.boat_A_id, f"{args.boat_A_id}_norm_stat.npz"))
        ...
        self.dataset_B = self.loadPickleFile(os.path.join(
            args.preprocessed_data_dir, args.boat_B_id, f"{args.boat_B_id}_normalized.pickle"))
        dataset_B_norm_stats = np.load(os.path.join(
            args.preprocessed_data_dir, args.boat_B_id, f"{args.boat_B_id}_norm_stat.npz"))
