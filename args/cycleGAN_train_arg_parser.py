...
class CycleGANTrainArgParser(TrainArgParser):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--sample_rate', type=int, default=5000, help='Sampling rate of mel-spectrograms.')
        self.parser.add_argument(
            '--boat_A_id', type=str, default="1", help='Source boat id')
        self.parser.add_argument(
            '--boat_B_id', type=str, default="2", help='Target boat id')
        self.parser.add_argument(
